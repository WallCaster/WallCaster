/*
  ...
  ```
*/
import { MagnifyingGlassIcon, AdjustmentsHorizontalIcon, UserCircleIcon, UserGroupIcon, FunnelIcon } from '@heroicons/react/24/outline';
...
const navigation = [
  ...
  { name: 'Integrations', href: '#integration', icon: UserGroupIcon, current: false },
];
